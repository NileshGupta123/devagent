...
const features = [
  ...
  },
  {
    icon: '⚡',
    title: 'Groq Powered',
    desc: 'Powered by Groq\'s ultra-fast inference with llama-3.3-70b model. Analyze entire repos in under 60 seconds.',
...
const stats = [
  ...
  { value: '70B',   label: 'LLM Parameters',  icon: '🧠' },
      ...
      <section className="max-w-7xl mx-auto px-6 text-center space-y-8 py-16">
        ...
        <div className="flex justify-center">
          <div className="flex items-center gap-2 px-4 py-2 rounded-full
                          bg-primary/10 border border-primary/20 text-sm text-primary">
            <span className="animate-pulse">●</span>
            <span>Powered by LangGraph + Groq llama-3.3-70b</span>
          </div>
        </div>
        ...
        <h1 className="text-6xl md:text-7xl font-black leading-tight">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
            DevAgent deploys 4 specialized AI agents that collaborate to analyze,
            fix, test, and evaluate any GitHub repository — then learn from the results.
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="card space-y-8">
          <div className="text-center space-y-2">
            <h2 className="text-3xl font-bold text-white">How the Pipeline Works</h2>
            <p className="text-gray-400">4 agents working in sequence with a feedback loop</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            {[
              ...
              <div key={step.label} className="flex items-center gap-4">
                <div className={`card ${step.color} text-center min-w-[110px] space-y-1
                                 hover:scale-105 transition-all duration-300`}>
          ...
          <div className="flex justify-center">
            <div className="flex items-center gap-2 px-4 py-2 rounded-full
                            bg-yellow-500/10 border border-yellow-500/20 text-sm text-yellow-400">
